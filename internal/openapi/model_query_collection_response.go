...
func (o *QueryCollectionResponse) GetFeatureScoreWeight() float64 {
	if o == nil || o.FeatureScoreWeight == nil {
		var ret float64
		return ret
	}
	return *o.FeatureScoreWeight
}

// GetFeatureScoreWeightOk returns a tuple with the FeatureScoreWeight field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryCollectionResponse) GetFeatureScoreWeightOk() (*float64, bool) {
	if o == nil || o.FeatureScoreWeight == nil {
		return nil, false
	}
	return o.FeatureScoreWeight, true
}
...
func (o QueryCollectionResponse) MarshalJSON() ([]byte, error) {
	...
	if o.FeatureScoreWeight != nil {
		toSerialize["feature_score_weight"] = o.FeatureScoreWeight
	}
	if o.Pipeline != nil {
