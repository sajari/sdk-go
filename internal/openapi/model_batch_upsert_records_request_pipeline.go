...
func NewBatchUpsertRecordsRequestPipeline(name string) *BatchUpsertRecordsRequestPipeline {
	this := BatchUpsertRecordsRequestPipeline{}
	this.Name = name
	return &this
}

// NewBatchUpsertRecordsRequestPipelineWithDefaults instantiates a new BatchUpsertRecordsRequestPipeline object
...
type NullableBatchUpsertRecordsRequestPipeline struct {
	value *BatchUpsertRecordsRequestPipeline
	isSet bool
}
...
func NewNullableBatchUpsertRecordsRequestPipeline(val *BatchUpsertRecordsRequestPipeline) *NullableBatchUpsertRecordsRequestPipeline {
	return &NullableBatchUpsertRecordsRequestPipeline{value: val, isSet: true}
}
