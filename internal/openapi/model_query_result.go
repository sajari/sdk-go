...
func (o *QueryResult) GetNeuralScore() float64 {
	if o == nil || o.NeuralScore == nil {
		var ret float64
		return ret
	}
	return *o.NeuralScore
}

// GetNeuralScoreOk returns a tuple with the NeuralScore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryResult) GetNeuralScoreOk() (*float64, bool) {
	if o == nil || o.NeuralScore == nil {
		return nil, false
	}
	return o.NeuralScore, true
}
...
func (o QueryResult) MarshalJSON() ([]byte, error) {
	...
	if o.FeatureScore != nil {
		toSerialize["feature_score"] = o.FeatureScore
	}
	if o.IndexScore != nil {
		toSerialize["index_score"] = o.IndexScore
	}
	if o.NeuralScore != nil {
		toSerialize["neural_score"] = o.NeuralScore
	}
	if o.Record != nil {
